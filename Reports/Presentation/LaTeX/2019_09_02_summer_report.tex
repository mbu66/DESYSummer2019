        ...
        \only<1>{%
            ...
            \end{equation}
              ...
              \begin{minipage}{0.49\textwidth}
                  ...
                  \includegraphics[width=0.8\textwidth]{\imagepath/Mass.pdf}
              \end{minipage}
...
\begin{frame}\frametitle{My Processor \OrangeBF{Angle Extractions}}
        ...
        \includegraphics[width=\textwidth]{\imagepath/ThetaMin.pdf}
        \end{minipage}\hfill
        \begin{minipage}{0.32\textwidth}
        \includegraphics[width=\textwidth]{\imagepath/ThetaLep.pdf}
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
...
\begin{frame}\frametitle{Efficiencies \OrangeBF{Applying cuts}}
      ...
      \begin{minipage}{0.49\textwidth}
          ...
          \begin{table}[!]
            ...
            \caption{
              Selection efficiency of sequantially applied cuts. Where the post ISR correction ${m}_{W}^{lep}$ was calculated using all 3 possible ${E}_{\gamma}$ solutions. (*) Means my and Ivan's cuts differ slightly
                ...
                \begin{tabular}{|l|l|l|l|l|} \hline
                  ...
                  1 & track multiplicity ${n}_{tracks} \ge 10$ & 97.13 & 97.01 & 99.996 \\ \hline
                  ...
                  8 & tau discrimination &  76.05 & 75.60 &  74.07 \\ \hline
                  9 & charged lepton (*) & 76.05 & 75.60 & 73.51 \\ \hline
                  10 & isolation variable ${\Delta\Omega}_{iso} > 0.5$ & 76.01 & 75.58 & 73.42 \\ \hline
            ...
            The selection efficiencies of the extracted angles after applying all the previous cuts, with the angular distribution below for reference\\
            \begin{minipage}{0.32\textwidth}
            \includegraphics[width=\textwidth]{\imagepath/E_ThetaMin.pdf}
            \includegraphics[width=\textwidth]{\imagepath/ThetaMin.pdf}
            \end{minipage}\hfill
            \begin{minipage}{0.32\textwidth}
            \includegraphics[width=\textwidth]{\imagepath/E_ThetaLep.pdf}
            \includegraphics[width=\textwidth]{\imagepath/ThetaLep.pdf}
            \end{minipage}
            \begin{minipage}{0.32\textwidth}
            \includegraphics[width=\textwidth]{\imagepath/E_PhiLep.pdf}
            \includegraphics[width=\textwidth]{\imagepath/PhiLep.pdf}
            \end{minipage}
        }
...
% ----------------------------------------------------------------------------
\begin{frame}\frametitle{Back Up \OrangeBF{Slides}}
    \only<1>{%
    \begin{minipage}{0.49\textwidth}
        \centering
