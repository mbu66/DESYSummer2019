\subsection{Low Statistics Figures}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Boost.pdf}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Mass.pdf}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Jet.pdf}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Lep.pdf}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Mass3.pdf}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Photon.pdf}
\includegraphics[width=0.5\textwidth]{\imagepath/../low_stat/Photon_zoom.pdf}
