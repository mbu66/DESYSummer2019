 ...
 {\lambda} &= \frac{1}{2}[{(500 - E)}^2 - {p}^{2} + \cancelto{0}{{m}_{\gamma}^{2} }- \cancelto{0}{{m}_{\nu}^{2}}]\\
  ...
  &= \frac{ \frac{1}{2}[{(500 - E)}^2 - {p}^{2}]}{(500 - E)  \mp {p}_{z}} \\
   &= \frac{ {(500 - E)}^2 - {p}^{2}}{1000 -2 E  \mp 2{p}_{z}}\, .
     \end{align}
  c.f Ivan's result \cite{Marchesini:2011aka}
  \\
...
\subsection{Backup Figures}
\label{App:LogFigures}
\subsubsection{Log plots of Mass reconstruction}
\includegraphics[width=0.49\textwidth]{\imagepath/Mass3_log.pdf}
\includegraphics[width=0.49\textwidth]{\imagepath/Mass_log.pdf}\\
\subsubsection{Number of isolated leptons reconstructed}
\includegraphics[width=0.49\textwidth]{\imagepath/IsolepsFound.pdf}
\subsubsection{Generator level ISR mass}
\includegraphics[width=0.49\textwidth]{\imagepath/MCPhotonMass.pdf}
\includegraphics[width=0.49\textwidth]{\imagepath/MCPhotonMass_log.pdf}\\
\subsubsection{ISR energy reconstruction with all 3 solutions}
\includegraphics[width=0.49\textwidth]{\imagepath/PhotonEnergy_2D_new.pdf}
\includegraphics[width=0.49\textwidth]{\imagepath/PhotonEnergy_2D_new_full.pdf}\\
\subsubsection{Cut flow with lepton cut applied simultaneously with $\textbf{n}_{tracks}$}
\includegraphics[width=0.49\textwidth]{\imagepath/Histflow3_isolep.pdf}\\
\label{App:HistFLowIsolep}
