...
\\\\
The solution that reconstructs the invariant mass of the W boson closer to the currently accepted value of 80.3 GeV \cite{pdgLive} is selected.  This may shift more of the background into the peak introducing a bias and so the appropriate cut was made to mitigate this \cite{Marchesini:2011aka}.
\\\\
...
\begin{figure}[!]
  ...
  \caption{
    ...
    \subfigref{SUBFIG:MassFig} A non-zero invarient ISR photon mass, obtained from generator level information, is considered.
    }
  \label{FIG:BoostMass}
\end{figure}
