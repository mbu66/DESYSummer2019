...
void MyFirstObservableProcessor::setObservablesBranches( TTree* tree ){
  /**
  Fill tree with branches for analysis
  **/
  ...
  //Reconstructed variables from ISR corrections
  ...
  //Reconstructed isolated lepton variables
  ...
  //Reconstructed hadronic W boson variables variables
  ...
  //Reconstructed leptonic W boson variables variables
  ...
  tree->Branch( "m_mcLeptonicEnergy",        &m_mcLeptonicWMomentumEnergy, "m_mcLeptonicMomentumEnergy/D");
  tree->Branch( "m_mcLeptonicMomentumT",     &m_mcLeptonicWMomentumT,      "m_mcLeptonicMomentumT/D");
...
void MyFirstObservableProcessor::setTTreeBranches() {
  /**
  Fill Trees with empty branches
  **/
