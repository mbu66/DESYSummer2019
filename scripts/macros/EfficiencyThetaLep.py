...
hist = TH1F("hist", ";#theta*_{l} [rad]; a.u.", 100, -1, 1 )
hist.SetLineColor(kBlack)
hist.SetLineWidth(3)
hist1 = TH1F("hist1", "; #theta*_{l} [rad]; a.u.", 100, -1, 1)
hist1.SetLineColor(kBlack)
hist1.SetLineWidth(3)

hist_P = TH1F("hist_P", ";#theta*_{l} [rad]; a.u.", 100, -1, 1 )
hist_P.SetLineColor(kRed)
hist_P.SetLineWidth(3)
hist_P1 = TH1F("hist_P1", "; #theta*_{l} [rad]; a.u.", 100, -1, 1)
