# Histogram showing the effect of boosting into the CoM frame
# on the reconstruction of the leptionic W mass

from ROOT import *

# Load in root trees
f = TFile("../root_files/extraction_long_noboost.root")
...
legend.AddEntry(hist, "No boost", "l")
legend.AddEntry(hist1, "Boosted", "l")
legend.Draw()
