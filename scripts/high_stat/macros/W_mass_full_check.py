...
g = TFile("extraction_long_mass.root")
...
for i in range(0,nEntries):
  t.GetEntry(i)
  r.GetEntry(i)
  hist.Fill(t.m_w_lepMass_2, applycut(t) and t.m_lambda >= 0)
  if applycut(t)and t.m_lambda >= 0:
      a += 1
  hist1.Fill(r.m_w_lepMass_2, applycut(r) and r.m_lambda >= 0)
  if applycut(r)and t.m_lambda >= 0:
      b += 1
...
legend.AddEntry(hist, "#splitline{Zero}{Invarient Mass}", "l")
legend.AddEntry(hist1, "#splitline{Invarient Mass}{from MC}", "l")
legend.Draw()

#c1.Print("plots/check_mass.root")
print(a)
print(b)
